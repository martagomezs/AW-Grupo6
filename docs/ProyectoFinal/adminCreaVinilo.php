...
if(isset($_POST['create'])){
    ...
    $ventas = 0;
    if (es\ucm\fdi\aw\Vinilo\Vinilo::insertaAdmin($titulo, $autor, $idAutor, $precio, $portada, $ventas, $stock)){
...
if(isset($_POST['boton'])){
    ...
    $artista = es\ucm\fdi\aw\Artista\Artista::buscaPorId($idArtista);
