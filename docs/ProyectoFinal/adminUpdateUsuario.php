...
$usuarios = es\ucm\fdi\aw\Usuario\Usuario::buscaUsuarios();
if(!esAdmin()){
...
if(isset($_POST['update'])){
    if(isset($_POST['username'])){
        $nuevo = es\ucm\fdi\aw\Usuario\Usuario::buscaPorUsername($_POST['username']);
    }
    ...
    if(isset($_POST['correo'])){
        if(es\ucm\fdi\aw\Usuario\Usuario::actualizaCorreoAdmin($_POST['correo'],$_POST['username'])){
...
if(isset($_POST['boton'])){
    $nuevo = es\ucm\fdi\aw\Usuario\Usuario::buscaPorUsername($_POST['usuario']);
